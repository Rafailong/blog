...
title: dollar-sign operator
authors: [ravila]
tags: [haskell]
---

The `($)` operator is a convenience for when
you want to express something with less pairs of parenths.
...
Above code we need all the parenths because we want to
first evaluate `(2 + 2)`.
